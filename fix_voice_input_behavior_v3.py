...
backup = root / f"backup_fix_voice_input_panel_{stamp}.py"
...
# ============================================================
# 2. Reemplazar AIMiniPanel completo por versión corregida
# ============================================================
...
if pattern.search(text):
    text = pattern.sub(new_panel.rstrip() + "\n\n", text)
else:
    pos = text.find("class HologramWindow")
    if pos == -1:
        raise RuntimeError("No encontré class HologramWindow")
    text = text[:pos] + new_panel + "\n\n" + text[pos:]

# Botón NEMOTRON debe abrir panel interno
...
print("PATCH OK")
print("- HABLAR solo dicta y no envía automáticamente")
print("- ENVIAR limpia la caja de texto")
print("- Mejorados parámetros de micrófono")
print("- Botones bloqueados durante escucha/envío")
