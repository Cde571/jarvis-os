...
backup = root / f"backup_fix_ai_panel_response_{stamp}.py"
...
# pyqtSignal para devolver respuesta desde hilo sin congelar UI
...
# Recalcular líneas tras imports
lines = text.splitlines()

# ============================================================
# 2. Reemplazar AIMiniPanel completo
# ============================================================
...
new_panel = '''class AIMiniPanel(QDialog):
    ...
    Usa señal PyQt para actualizar la respuesta desde un hilo sin bloquear la app.
    """
    ...
    def speak_text(self, text: str):
        ...
        def worker():
            try:
                ...
                self.response_ready.emit(f"[VOICE ERROR] {exc}")
...
# ============================================================
# 4. Asegurar atributo ai_mini_panel
# ============================================================
...
# ============================================================
# 5. Botón NEMOTRON abre panel interno
# ============================================================
...
print("PATCH OK")
print("- Textos del panel corregidos")
print("- Respuesta interna usa pyqtSignal")
print("- No debe quedarse en 'pensando...'")
print("- Botón NEMOTRON abre mini panel interno")
