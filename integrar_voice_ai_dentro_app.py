...
backup = root / f"backup_voice_inside_app_{stamp}.py"
...
# ============================================================
# 2. Reemplazar clase AIMiniPanel completa por versión interna
# ============================================================

new_ai_panel = r'''class AIMiniPanel(QDialog):
    """
    Mini interfaz interna para hablar con Nemotron.
    Todo ocurre dentro de JARVIS:
    - escribir prompt
    - escuchar micrófono
    - enviar a LM Studio / Nemotron
    - responder en texto
    - repetir respuesta por voz
    """
    ...
    def listen_in_app(self):
        """
        Escucha desde micrófono dentro de la app.
        Requiere SpeechRecognition + PyAudio.
        """
...
if pattern.search(ui):
    ui = pattern.sub(new_ai_panel.rstrip() + "\n\n", ui)
else:
    ...
    ui = ui[:pos] + new_ai_panel + "\n\n" + ui[pos:]

# ============================================================
# 3. Asegurar que NEMOTRON abre el panel interno
# ============================================================
...
# ============================================================
# 4. Asegurar método _open_ai_panel
# ============================================================
...
print("PATCH OK")
print("- Voice AI ya vive dentro de la mini ventana de JARVIS")
print("- HABLAR CON JARVIS usa micrófono dentro de PyQt")
print("- ENVIAR A NEMOTRON responde dentro del panel")
print("- REPETIR VOZ usa pyttsx3")
print("- Ya no depende del navegador para la experiencia principal")
