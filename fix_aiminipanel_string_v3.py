...
backup = root / f"backup_fix_aiminipanel_string_{stamp}.py"
...
for widget in ["QTextEdit", "QLineEdit", "QVBoxLayout", "QHBoxLayout", "QLabel", "QPushButton"]:
    if widget not in ui:
        ui = ui.replace(
            "from PyQt6.QtWidgets import (",
...
# ============================================================
# 2. Reemplazar AIMiniPanel completo por versión segura
# ============================================================
...
# ============================================================
# 3. Asegurar método _open_ai_panel
# ============================================================

open_panel_method = '''    def _open_ai_panel(self):
        """
...
if "def _open_ai_panel(self):" not in ui:
    ...
    ui = ui[:pos] + open_panel_method + "\n" + ui[pos:]

# Asegurar que NEMOTRON abre panel
...
print("PATCH OK")
print("- AIMiniPanel corregido")
print("- Textos multilinea corregidos con \\n")
print("- NEMOTRON abre panel interno")
